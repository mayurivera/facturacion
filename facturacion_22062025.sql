...
INSERT INTO `establecimientos` (`id_establecimiento`, `codigo`, `nombre`, `direccion`, `estado`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, '001', 'Oficina Principal Quito', 'Av. 10 de Agosto N20-123 y Colón, Edificio Corporativo', 'activo', '2025-06-22 15:35:16', NULL, 1, NULL, 'Manual'),
	(2, '002', 'Sucursal Guayaquil', 'Calle 9na No. 505 y Av. Principal, Centro Comercial del Sur', 'activo', '2025-06-22 15:35:16', NULL, 1, NULL, 'Manual');
...
-- Volcando estructura para tabla facturacion.formas_pago_factura
CREATE TABLE IF NOT EXISTS `formas_pago_factura` (
  `id_forma_pago` int(11) NOT NULL AUTO_INCREMENT,
  `id_factura` int(11) NOT NULL,
  `codigo_forma_pago` varchar(2) NOT NULL COMMENT 'Código forma de pago SRI (ej: 01, 19)',
  `descripcion` varchar(150) DEFAULT NULL COMMENT 'Descripción de la forma de pago',
  `valor` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Monto con esta forma de pago',
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_modificacion` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `usuario_creacion` int(11) DEFAULT NULL,
  `usuario_modificacion` int(11) DEFAULT NULL,
  ...
  KEY `fk_forma_pago_factura` (`id_factura`),
  CONSTRAINT `fk_forma_pago_factura` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id_factura`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.formas_pago_factura: ~2 rows (aproximadamente)
INSERT INTO `formas_pago_factura` (`id_forma_pago`, `id_factura`, `codigo_forma_pago`, `descripcion`, `valor`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`, `estado_registro`) VALUES
	(1, 1, '01', 'Efectivo', 60.00, '2025-06-22 22:30:36', NULL, 1, NULL, 'insert de prueba', 'activo'),
	(2, 1, '19', 'Tarjeta de crédito', 52.00, '2025-06-22 22:30:36', NULL, 1, NULL, 'insert de prueba', 'activo');
