...
-- Volcando estructura para tabla facturacion.campos_adicionales_factura
CREATE TABLE IF NOT EXISTS `campos_adicionales_factura` (
  `id_campo_adicional` int(11) NOT NULL AUTO_INCREMENT,
  `id_factura` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL COMMENT 'Nombre del campo adicional',
  `valor` varchar(255) NOT NULL COMMENT 'Valor del campo adicional',
  ...
  PRIMARY KEY (`id_campo_adicional`),
  KEY `fk_campo_adicional_factura` (`id_factura`),
  CONSTRAINT `fk_campo_adicional_factura` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id_factura`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.campos_adicionales_factura: ~2 rows (aproximadamente)
INSERT INTO `campos_adicionales_factura` (`id_campo_adicional`, `id_factura`, `nombre`, `valor`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`, `estado_registro`) VALUES
	(1, 1, 'Correo Adicional', 'cliente@ejemplo.com', '2025-06-22 22:30:36', NULL, 1, NULL, 'insert de prueba', 'activo'),
	(2, 1, 'Observación', 'Entrega inmediata', '2025-06-22 22:30:36', NULL, 1, NULL, 'insert de prueba', 'activo');
...
-- Volcando datos para la tabla facturacion.categorias: ~24 rows (aproximadamente)
INSERT INTO `categorias` (`id_categoria`, `nombre_categoria`, `descripcion`, `estado`, `fecha_creacion`) VALUES
	...
	(20, 'Turbos', 'Categoría de Turbos', 'inactivo', '2025-06-11 02:44:27'),
	(21, 'XXX', 'ZZZy', 'activo', '2025-06-13 01:00:18'),
	(22, 'rwerqwr', 'qwreqwer', 'activo', '2025-06-29 23:33:34'),
	(23, 'popweirtpewot', 'poipipoi', 'inactivo', '2025-06-29 23:37:13'),
	(24, 'llll', 'wwwwwwwwwwww', 'activo', '2025-06-29 23:41:35');
...
-- Volcando datos para la tabla facturacion.clientes: ~62 rows (aproximadamente)
INSERT INTO `clientes` (`id_cliente`, `razon_social`, `ruc_cedula`, `tipo_identificacion`, `direccion`, `telefono`, `correo`, `estado`, `fecha_registro`, `estado_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	...
	(41, 'Esteban Mendoza', '1710900112', 'Cedula', 'Calle Rocafuerte N150-56', '0985997766', 'emendoza@gmail.com', 'activo', '2025-06-29 23:00:46', 'activo', NULL, NULL, NULL, NULL),
	(42, 'Esteban Mendoza', '1710900112', 'Cedula', 'Calle Rocafuerte N150-56', '0985997766', 'emendoza@mail.com', 'activo', '2025-06-29 23:06:18', 'activo', NULL, NULL, NULL, NULL),
	(43, 'Esteban Mendoza', '1710900115', 'Cedula', 'Calle Rocafuerte N150-56', '0985997766', 'emendoza@outmail.com', 'activo', '2025-06-29 23:06:39', 'activo', NULL, NULL, NULL, NULL),
	(44, 'Esteban Mendoza', '1710900156', 'Cedula', 'Calle Rocafuerte N150-564', '0985997799', 'emendoza@gmail.com', 'activo', '2025-06-29 23:07:08', 'activo', NULL, NULL, NULL, NULL),
	(45, 'Patricio Garcia', '1710900115', 'Cedula', 'Calle Rocafuerte N150-56', '0985997766', 'emendoza@outmail.com', 'activo', '2025-06-29 23:07:46', 'activo', NULL, NULL, NULL, NULL),
	(46, 'Patricio Garcia', '1710900115', 'Cedula', 'Calle Rocafuerte N150-56', '0985997766', 'pgarcia@outmail.com', 'activo', '2025-06-29 23:08:29', 'activo', NULL, NULL, NULL, NULL),
	(47, 'Esteban Mendoza', '1710900156', 'Cedula', 'Calle Rocafuerte N150-564', '0985997799', 'emendoza@gmail.com', 'activo', '2025-06-29 23:08:51', 'activo', NULL, NULL, NULL, NULL),
	(48, 'tertyertyerty', '987987987987987', 'RUC', 'jkghkjgjhghj', '6546465455', 'kjhkjhkj@lkjlkj.com', 'activo', '2025-06-29 23:27:18', 'activo', NULL, NULL, NULL, NULL),
	(49, 'tertyertyerty', '987987987987987', 'RUC', 'jkghkjgjhghj', '6546465455', 'kjhkjhkj@lkjlkj.com', 'activo', '2025-06-29 23:42:33', 'activo', NULL, NULL, NULL, NULL),
	(50, 'QQQQQQQQQ', '546546464', 'RUC', '464564654', '6546465', 'FSDFG@FAF.COM', 'activo', '2025-06-30 00:38:20', 'activo', NULL, NULL, NULL, NULL),
	(51, 'kjghkhkiuhi', '978979789', 'RUC', 'hgfhgh', '987979', 'mhbaf@falsf.com', 'activo', '2025-06-30 01:32:12', 'activo', NULL, NULL, NULL, NULL),
	(52, 'kjghkhkiuhi', '978979789', 'RUC', 'hgfhgh', '987979', 'mhbaf@falsf.com', 'inactivo', '2025-06-30 01:52:15', 'activo', NULL, NULL, NULL, NULL),
	(53, 'qroqireou|', '987987987', 'Cedula', 'lijoiuoiu', '654654654', 'kjhkjhfs@glsjgk.com', 'activo', '2025-06-30 01:55:06', 'activo', NULL, NULL, NULL, NULL),
	(54, 'qroqireou|', '987987987', 'Cedula', 'lijoiuoiu', '654654654', 'kjhkjhfs@glsjgk.org', 'inactivo', '2025-06-30 01:55:54', 'activo', NULL, NULL, NULL, NULL),
	(55, 'uytuytuytyu', '1715635312', 'Cedula', 'kjgjhgjhg', '98798789', 'kjkjhfs@lkgjsg.com', 'activo', '2025-06-30 02:24:19', 'activo', NULL, NULL, NULL, NULL),
	(56, 'oiououoiu', '1715635304', 'Cedula', 'uytuytyu', '9879878979', 'kjhkjhfs@lkhjgskjg.com', 'activo', '2025-06-30 02:25:38', 'activo', NULL, NULL, NULL, NULL),
	(57, 'uytuytuytyu', '1715635315', 'Cedula', 'kjgjhgjhg', '98798789', 'kjkjhfs@lkgjsg.com', 'activo', '2025-06-30 02:25:53', 'activo', NULL, NULL, NULL, NULL),
	(58, 'lkjlkjklj', '1715624662', 'Cedula', 'jhgjhgjhgj', '7997979789', 'khjaskjf@ksjg.com', 'activo', '2025-06-30 02:31:44', 'activo', NULL, NULL, NULL, NULL),
	(59, 'lkjlkjklj', '1715624662', 'Cedula', 'jhgjhgjhgj', '7997979789', 'khjaskjf@ksjg.com', 'inactivo', '2025-06-30 02:36:15', 'activo', NULL, NULL, NULL, NULL),
	(60, 'lkjlkjklj', '1715624662', 'Cedula', 'jhgjhgjhgj', '7997979789', 'khjaskjf@ksjg.com', 'activo', '2025-06-30 02:36:22', 'activo', NULL, NULL, NULL, NULL),
	(61, 'lkjlkjklj', '1715624662', 'Cedula', 'jhgjhgjhgj', '7997979789', 'khjaskjf@ksjg.com', 'inactivo', '2025-06-30 02:44:08', 'activo', NULL, NULL, NULL, NULL),
	(62, 'lkjlkjklj', '1715624662', 'Cedula', 'jhgjhgjhgj', '7997979789', 'khjaskjf@ksjg.com', 'activo', '2025-06-30 02:45:41', 'activo', NULL, NULL, NULL, NULL);
...
-- Volcando datos para la tabla facturacion.detalle_factura: ~2 rows (aproximadamente)
INSERT INTO `detalle_factura` (`id_detalle`, `id_factura`, `id_producto`, `cantidad`, `precio_unitario`, `total_linea`, `fecha_registro`, `estado_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, 1, 1, 2, 25.00, 50.00, '2025-06-22 22:30:36', 'activo', NULL, 1, NULL, 'insert de prueba'),
	(2, 1, 2, 1, 50.00, 50.00, '2025-06-22 22:30:36', 'activo', NULL, 1, NULL, 'insert de prueba');

-- Volcando estructura para tabla facturacion.establecimientos
CREATE TABLE IF NOT EXISTS `establecimientos` (
  ...
  `matriz` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '1 Matriz, 0 Sucursal',
  `nombre` varchar(150) NOT NULL COMMENT 'Nombre del establecimiento',
  `direccion` text DEFAULT NULL COMMENT 'Dirección física del establecimiento',
  ...
  `fecha_modificacion` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `usuario_creacion` int(11) DEFAULT NULL COMMENT 'ID usuario creador',
  `usuario_modificacion` int(11) DEFAULT NULL COMMENT 'ID usuario modificador',
  `origen_dato` varchar(100) DEFAULT NULL COMMENT 'Origen del dato',
  PRIMARY KEY (`id_establecimiento`),
  UNIQUE KEY `codigo` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.establecimientos: ~2 rows (aproximadamente)
INSERT INTO `establecimientos` (`id_establecimiento`, `codigo`, `matriz`, `nombre`, `direccion`, `estado`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, '001', 1, 'Oficina Principal Quito', 'Av. 10 de Agosto N20-123 y Colón, Edificio Corporativo', 'activo', '2025-06-22 15:35:16', '2025-07-01 02:28:08', 1, NULL, 'Manual'),
	(2, '002', 0, 'Sucursal Guayaquil', 'Calle 9na No. 505 y Av. Principal, Centro Comercial del Sur', 'activo', '2025-06-22 15:35:16', NULL, 1, NULL, 'Manual');
...
CREATE TABLE IF NOT EXISTS `facturas` (
  ...
  `estado_anterior` enum('emitida','firmada','enviada','autorizada','anulada') DEFAULT NULL,
  ...
  `motivo_cambio_estado` varchar(255) DEFAULT NULL,
...
INSERT INTO `facturas` (`id_factura`, `establecimiento`, `punto_emision`, `secuencia`, `clave_acceso`, `codigo_autorizacion`, `fecha_emision`, `id_cliente`, `id_usuario`, `subtotal`, `iva`, `total`, `estado`, `estado_anterior`, `tipo_emision`, `ambiente`, `ruta_xml_generado`, `ruta_pdf`, `mensaje_sri`, `fecha_registro`, `fecha_modificacion`, `fecha_cambio_estado`, `usuario_cambio_estado`, `motivo_cambio_estado`, `estado_registro`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, '001', '001', 1, '1234567890123456789012345678901234567890123456789', 'AUT123456789', '2025-06-22 22:30:36', 1, 1, 100.00, 12.00, 112.00, 'emitida', NULL, 'normal', 'pruebas', '/xmls/factura_1.xml', '/pdfs/factura_1.pdf', NULL, '2025-06-22 22:30:36', NULL, NULL, NULL, NULL, 'activo', 1, NULL, 'insert de prueba');

-- Volcando estructura para tabla facturacion.formas_pago_catalogo
CREATE TABLE IF NOT EXISTS `formas_pago_catalogo` (
  `id_forma_pago_catalogo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único',
  `codigo_forma_pago` varchar(2) NOT NULL COMMENT 'Código de forma de pago según el SRI',
  `descripcion` varchar(100) NOT NULL COMMENT 'Descripción de la forma de pago',
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de registro',
  `fecha_modificacion` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp() COMMENT 'Última modificación',
  `usuario_creacion` int(11) DEFAULT NULL COMMENT 'ID del usuario que creó el registro',
  `usuario_modificacion` int(11) DEFAULT NULL COMMENT 'ID del usuario que modificó el registro',
  `origen_dato` varchar(100) DEFAULT NULL COMMENT 'Origen del dato (módulo, API, etc.)',
  `estado_registro` enum('activo','inactivo','eliminado') DEFAULT 'activo' COMMENT 'Estado lógico del registro',
  PRIMARY KEY (`id_forma_pago_catalogo`),
  UNIQUE KEY `u_codigo_forma_pago` (`codigo_forma_pago`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.formas_pago_catalogo: ~7 rows (aproximadamente)
INSERT INTO `formas_pago_catalogo` (`id_forma_pago_catalogo`, `codigo_forma_pago`, `descripcion`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`, `estado_registro`) VALUES
	(1, '01', 'Sin utilización del sistema financiero', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(2, '15', 'Compensación de deudas', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(3, '16', 'Tarjeta de débito', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(4, '17', 'Dinero electrónico', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(5, '18', 'Tarjeta de crédito', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(6, '19', 'Otros con utilización del sistema financiero', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo'),
	(7, '20', 'Endoso de títulos', '2025-07-01 00:46:47', NULL, NULL, NULL, NULL, 'activo');

-- Volcando estructura para tabla facturacion.iva_tarifas
CREATE TABLE IF NOT EXISTS `iva_tarifas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo_iva` varchar(2) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_iva` (`codigo_iva`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.iva_tarifas: ~9 rows (aproximadamente)
INSERT INTO `iva_tarifas` (`id`, `codigo_iva`, `descripcion`, `porcentaje`, `estado`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, '0', '0%', 0.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:17:49', 'admin', NULL),
	(2, '2', '12%', 12.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:17:54', 'admin', NULL),
	(3, '3', '14%', 14.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:17:34', 'admin', NULL),
	(4, '4', '15%', 15.00, 'activo', '2025-06-30 23:17:34', '2025-06-30 23:17:34', 'admin', NULL),
	(5, '5', '5%', 5.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:17:57', 'admin', NULL),
	(6, '6', 'No objeto de IVA', 0.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:18:00', 'admin', NULL),
	(7, '7', 'Exento de IVA', 0.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:18:03', 'admin', NULL),
	(8, '8', 'IVA diferenciado', 0.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:18:06', 'admin', NULL),
	(9, '10', '13%', 13.00, 'inactivo', '2025-06-30 23:17:34', '2025-06-30 23:18:09', 'admin', NULL);
...
CREATE TABLE IF NOT EXISTS `parametros_sri` (
  ...
  `tarifa_iva` decimal(5,2) NOT NULL DEFAULT 15.00 COMMENT 'Tarifa de IVA predeterminada para facturación (ej: 15.00%)',
...
-- Volcando datos para la tabla facturacion.parametros_sri: ~0 rows (aproximadamente)
INSERT INTO `parametros_sri` (`id_parametro`, `ambiente`, `url_autorizacion`, `url_recepcion`, `dominio_produccion`, `dominio_pruebas`, `ruc_emisor`, `razon_social`, `nombre_comercial`, `tarifa_iva`, `fecha_registro`, `estado_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, 'produccion', '/comprobantes-electronicos-ws/AutorizacionComprobantes?wsdl', '/comprobantes-electronicos-ws/RecepcionComprobantes?wsdl', 'https://cel.sri.gob.ec', 'https://pruebas.sri.gob.ec', '1799999999001', 'EMPRESA DE OTRO S.A.', 'COMERCIAL EJEMPLO', 15.00, '2025-06-14 20:07:57', 'activo', '2025-06-14 23:13:37', 1, 1, 'registro inicial');
...
-- Volcando datos para la tabla facturacion.productos: ~104 rows (aproximadamente)
INSERT INTO `productos` (`id_producto`, `codigo`, `nombre`, `descripcion`, `id_categoria`, `precio_unitario`, `stock`, `estado`, `fecha_creacion`) VALUES
	...
	(102, 'qwerw', 'werqwerqwr', 'ssssssssss', 6, 10.20, 12, 'inactivo', '2025-06-12 04:18:20'),
	(103, '103', 'KKKKKKK', 'OOOOOoo', 4, 1.80, 10, 'inactivo', '2025-06-13 01:03:23'),
	(104, 'ññññññ', 'pppppppppppp', 'ooooooooo', 18, 0.01, 1, 'activo', '2025-06-29 23:53:27');

-- Volcando estructura para tabla facturacion.productos_vendidos
CREATE TABLE IF NOT EXISTS `productos_vendidos` (
  `id_producto_vendido` int(11) NOT NULL AUTO_INCREMENT,
  `id_factura` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_producto_vendido_factura` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id_factura`) ON DELETE CASCADE,
  CONSTRAINT `fk_producto_vendido_producto` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.productos_vendidos: ~2 rows (aproximadamente)
INSERT INTO `productos_vendidos` (`id_producto_vendido`, `id_factura`, `id_producto`, `cantidad`, `precio_unitario`, `total_linea`, `fecha_venta`, `usuario_creacion`, `estado_registro`, `origen_dato`) VALUES
	(1, 1, 1, 2, 25.00, 50.00, '2025-06-22 22:35:43', 1, 'activo', 'insert de prueba'),
	(2, 1, 2, 1, 50.00, 50.00, '2025-06-22 22:35:43', 1, 'activo', 'insert de prueba');

-- Volcando estructura para tabla facturacion.puntos_emision
CREATE TABLE IF NOT EXISTS `puntos_emision` (
  `id_punto` int(11) NOT NULL AUTO_INCREMENT,
  `id_establecimiento` int(11) NOT NULL COMMENT 'Relación con establecimiento',
  `codigo` varchar(3) NOT NULL COMMENT 'Código punto de emisión (ej: 001)',
  `descripcion` varchar(150) DEFAULT NULL COMMENT 'Descripción o nombre del punto',
  `estado` enum('activo','inactivo','eliminado') DEFAULT 'activo',
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_modificacion` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `usuario_creacion` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `codigo` (`codigo`,`id_establecimiento`),
  KEY `fk_punto_establecimiento` (`id_establecimiento`),
  CONSTRAINT `fk_punto_establecimiento` FOREIGN KEY (`id_establecimiento`) REFERENCES `establecimientos` (`id_establecimiento`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.puntos_emision: ~4 rows (aproximadamente)
INSERT INTO `puntos_emision` (`id_punto`, `id_establecimiento`, `codigo`, `descripcion`, `estado`, `fecha_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, 1, '001', 'Caja 1 - Ventas Generales', 'activo', '2025-06-22 15:35:29', NULL, 1, NULL, 'Manual'),
	(2, 1, '002', 'Caja 2 - Devoluciones', 'activo', '2025-06-22 15:35:29', NULL, 1, NULL, 'Manual'),
	(3, 2, '001', 'Recepción de Pagos', 'activo', '2025-06-22 15:35:29', NULL, 1, NULL, 'Manual'),
	(4, 2, '002', 'Ventas al por Mayor', 'activo', '2025-06-22 15:35:29', NULL, 1, NULL, 'Manual');
...
-- Volcando estructura para tabla facturacion.tipos_identificacion_comprador
CREATE TABLE IF NOT EXISTS `tipos_identificacion_comprador` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo` (`codigo`),
  CONSTRAINT `chk_codigo_valido` CHECK (`codigo` in ('01','02','03','04','05','06','07','08','09'))
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla facturacion.tipos_identificacion_comprador: ~9 rows (aproximadamente)
INSERT INTO `tipos_identificacion_comprador` (`id`, `codigo`, `descripcion`, `estado`, `creado_por`, `fecha_creacion`, `modificado_por`, `fecha_modificacion`) VALUES
	(1, '01', 'RUC', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(2, '02', 'Cédula', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(3, '03', 'Pasaporte', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(4, '04', 'Identificación del exterior (residente)', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(5, '05', 'Placa (para ventas de combustibles)', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(6, '06', 'Identificación del exterior (no residente)', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(7, '07', 'Consumidor final', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(8, '08', 'Identificación tributaria del exterior', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL),
	(9, '09', 'Documento de identidad extranjero', 'activo', 'admin', '2025-06-30 23:54:31', NULL, NULL);
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `correo`, `contraseña`, `id_rol`, `estado`, `fecha_creacion`, `fecha_registro`, `estado_registro`, `fecha_modificacion`, `usuario_creacion`, `usuario_modificacion`, `origen_dato`) VALUES
	(1, 'ADMINISTRADOR', 'acolumba@gmail.com', '$2y$10$nDP1KpC2gsUDNS8x4xV.3.dSju3dqeBnukhzghdDepCinfQgvGpBu', 1, 'activo', '2025-06-10 02:05:25', '2025-06-10 02:05:25', 'activo', '2025-06-29 22:38:51', NULL, 1, NULL);
